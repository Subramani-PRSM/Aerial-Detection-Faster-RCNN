...
def classAsTextToClassAsInt(classAsText):
    ...
    if classAsText == 'person':
        return 1
    if classAsText == 'car':
        return 2
    if classAsText == 'bench':
        return 3
    if classAsText == 'trolley':
        return 4
    if classAsText == 'drone':
        return 5
    if classAsText == 'table':
        return 6
    if classAsText == 'stone':
        return 7
    if classAsText == 'wood':
        return 8
    if classAsText == 'person is sitting':
        return 9
    if classAsText == 'two person':
        return 10
    else:
